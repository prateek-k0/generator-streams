...
// const stream2 = interval(1000, 0).take(5).map((val: number) => val * 2);
// const stream3 = interval(1000, 0).take(15).map((val: number) => val * 3);
...
// interval(500, 0).throttle(1000).subscribe((v) => console.log("throttle", v));
